...
import img from "@/assets/imgs/Mainland-Activities-2-min-1.png.webp";
...
const page = () => {
    return (
        <div>
            ...
            <div className='flex md:flex-row flex-col md:gap-20 gap-5 items-center mx-auto w-full md:w-7/12 mt-10 mb-10'>
                ...
                <p className=' text-center'>In line with our commitment to quality customer service, we have developed a partner program to provide our clients access to a range of exclusive services that will help them build the foundation of a great business.
